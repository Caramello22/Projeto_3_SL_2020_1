...
CREATE DATABASE tello CHARACTER SET utf8 COLLATE utf8_general_ci;
...
('siteOwner', 'Anna Mello'),
('siteOwnerEmail', 'anna@mello.com'),
('siteYear', '2021'),
('meta_author', 'Anna Mello'),
('meta_description', 'Site sobre fuinhas, furões e afins.'),
('meta_keywords', 'fuinha, furão, pet, exótico, mamífero'),
('meta_copyright', '© 2021 Anna Mello')
;